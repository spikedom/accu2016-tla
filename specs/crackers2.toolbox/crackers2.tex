...
\@x{}\moduleLeftDash\@xx{ {\MODULE} crackers2}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
 ...
 \{ \} ]}%
\@pvspace{8.0pt}%
\@x{ Desire \.{\defeq} \E\, p \.{\in} People \.{:}}%
\@x{\@s{54.47} \.{\land} desires [ p ] \.{=} \{ \}}%
\@x{\@s{54.47} \.{\land} \E\, t \.{\in} Things \.{:}}%
 \@x{\@s{65.58} \.{\land} desires \.{'} \.{=} [ desires {\EXCEPT} {\bang} [ p
 ] \.{=} \{ t \} ]}%
\@x{\@s{65.58} \.{\land} {\UNCHANGED} holds}%
\@pvspace{8.0pt}%
\@x{ Acquire \.{\defeq} \E\, p \.{\in} People \.{:}}%
\@x{\@s{60.18} \E\, t \.{\in} desires [ p ] \.{:}}%
\@x{\@s{68.38} \.{\land} t \.{\notin} holds [ p ]}%
 \@x{\@s{68.38} \.{\land} holds \.{'} \.{=} [ holds {\EXCEPT} {\bang} [ p ]
 \.{=} holds [ p ] \.{\cup} \{ t \} ]}%
\@x{\@s{68.38} \.{\land} {\UNCHANGED} desires}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} Desire}%
\@x{\@s{39.83} \.{\lor} Acquire}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
