...
\@x{}\moduleLeftDash\@xx{ {\MODULE} crackers7a}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, FiniteSets}%
\@x{ {\CONSTANTS} Things ,\, People}%
\@x{ {\VARIABLES} desires ,\, holds}%
\@pvspace{8.0pt}%
 \@x{ Init \.{\defeq} \.{\land} desires \.{=} [ p \.{\in} People \.{\mapsto}
 \{ \} ]}%
 \@x{\@s{35.70} \.{\land} holds\@s{7.28} \.{=} [ p \.{\in} People \.{\mapsto}
 \{ \} ]}%
\@x{}\midbar\@xx{}%
\@x{ {\RECURSIVE} \_SetOrdinals ( \_ ,\, \_ )}%
\@x{ \_SetOrdinals ( s ,\, f ) \.{\defeq} {\IF} s \.{=} \{ \}}%
\@x{\@s{98.66} \.{\THEN} f}%
 \@x{\@s{98.66} \.{\ELSE} \.{\LET} e \.{\defeq} {\CHOOSE} x \.{\in} s \.{:}
 {\TRUE}}%
 \@x{\@s{129.97} \.{\IN} \_SetOrdinals ( s \.{\,\backslash\,} \{ e \} ,\, [ f
 {\EXCEPT} {\bang} [ e ] \.{=} Cardinality ( s ) ] )}%
 \@x{ SetOrdinals ( S ) \.{\defeq} \_SetOrdinals ( S ,\, [ x \.{\in} S
 \.{\mapsto} 0 ] )}%
\@pvspace{8.0pt}%
\@x{ ResourceOrdinals \.{\defeq} SetOrdinals ( Things )}%
 \@x{ ChooseBefore ( a ,\, b ) \.{\defeq} ResourceOrdinals [ a ] \.{<}
 ResourceOrdinals [ b ]}%
\@x{}\midbar\@xx{}%
\@x{ Held ( t ) \.{\defeq} \E\, p \.{\in} People \.{:} t \.{\in} holds [ p ]}%
\@x{}\midbar\@xx{}%
 \@x{ Desire ( p ) \.{\defeq} \.{\land} holds [ p ] \.{\neq} \{ \}
 \.{\implies} desires [ p ] \.{\neq} \{ \}}%
\@x{\@s{60.77} \.{\land} \E\, t\@s{3.88} \.{\in} Things \.{:}}%
\@x{\@s{71.88} \.{\land} t \.{\notin} desires [ p ]}%
 \@x{\@s{71.88} \.{\land} desires \.{'} \.{=} [ desires {\EXCEPT} {\bang} [ p
 ] \.{=} desires [ p ] \.{\cup} \{ t \} ]}%
\@x{\@s{71.88} \.{\land} {\UNCHANGED} holds}%
\@pvspace{8.0pt}%
\@x{ Acquire ( p ) \.{\defeq} \E\, t \.{\in} desires [ p ] \.{:}}%
\@x{\@s{72.73} \.{\land} {\lnot} Held ( t )}%
 \@x{\@s{72.73} \.{\land} {\lnot} \E\, t2\@s{2.44} \.{\in} desires [ p ] \.{:}
 t2 \.{\notin} holds [ p ] \.{\land} ChooseBefore ( t2 ,\, t )}%
 \@x{\@s{72.73} \.{\land} holds \.{'} \.{=} [ holds {\EXCEPT} {\bang} [ p ]
 \.{=} holds [ p ] \.{\cup} \{ t \} ]}%
\@x{\@s{72.73} \.{\land} {\UNCHANGED} desires}%
\@pvspace{8.0pt}%
\@x{ Satiated ( p ) \.{\defeq} \.{\land} desires [ p ] \.{\neq} \{ \}}%
 \@x{\@s{68.19} \.{\land} \A\, t \.{\in} desires [ p ] \.{:} t \.{\in} holds [
 p ]}%
 \@x{\@s{68.19} \.{\land} desires \.{'} \.{=} [ desires {\EXCEPT} {\bang} [ p
 ] \.{=} \{ \} ]}%
\@x{\@s{68.19} \.{\land} {\UNCHANGED} holds}%
\@pvspace{8.0pt}%
\@x{ TidyUp ( p ) \.{\defeq} \.{\land} desires [ p ] \.{=} \{ \}}%
\@x{\@s{65.77} \.{\land} \E\, t \.{\in} holds [ p ] \.{:}}%
 \@x{\@s{76.88} \.{\land} holds \.{'} \.{=} [ holds {\EXCEPT} {\bang} [ p ]
 \.{=} holds [ p ] \.{\,\backslash\,} \{ t \} ]}%
\@x{\@s{76.88} \.{\land} {\UNCHANGED} desires}%
\@pvspace{8.0pt}%
\@x{ Relinquish ( p ) \.{\defeq} \E\, t \.{\in} desires [ p ] \.{:}}%
\@x{\@s{85.25} \.{\land} t \.{\notin} holds [ p ]}%
\@x{\@s{85.25} \.{\land} \E\, t2 \.{\in} holds [ p ] \.{:}}%
\@x{\@s{104.56} \.{\land} ChooseBefore ( t ,\, t2 )}%
 \@x{\@s{104.56} \.{\land} holds \.{'} \.{=} [ holds {\EXCEPT} {\bang} [ p ]
 \.{=} holds [ p ] \.{\,\backslash\,} \{ t2 \} ]}%
\@x{\@s{104.56} \.{\land} {\UNCHANGED} desires}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \E\, p \.{\in} People \.{:}}%
\@x{\@s{47.05} \.{\lor} Desire ( p )}%
\@x{\@s{47.05} \.{\lor} Acquire ( p )}%
\@x{\@s{47.05} \.{\lor} Satiated ( p )}%
\@x{\@s{47.05} \.{\lor} TidyUp ( p )}%
\@x{\@s{47.05} \.{\lor} Relinquish ( p )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ TidiesUp \.{\defeq} {\lnot} \E\, p \.{\in} People \.{:}}%
\@x{\@s{74.01} \.{\land} desires [ p ] \.{\neq} \{ \}}%
 \@x{\@s{74.01} \.{\land} \E\, l \.{\in} holds [ p ] \.{:} l \.{\notin}
 desires [ p ]}%
\@pvspace{8.0pt}%
 \@x{ Exclusivity \.{\defeq} {\lnot} \E\, p ,\, q\@s{7.87} \.{\in}
 People\@s{1.46} \.{:} p \.{\neq} q \.{\land} ( holds [ p ] \.{\cap} holds [
 q ] ) \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
\@x{ Ordering \.{\defeq} \.{\land} \A\, x ,\, y ,\, z \.{\in} Things \.{:}}%
 \@x{\@s{69.47} ChooseBefore ( x ,\, y ) \.{\land} ChooseBefore ( y ,\, z )
 \.{\implies} ChooseBefore ( x ,\, z )}%
 \@x{\@s{58.36} \.{\land} \A\, x \.{\in} Things \.{:} {\lnot} ChooseBefore ( x
 ,\, x )}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} desires ,\,
 holds {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
