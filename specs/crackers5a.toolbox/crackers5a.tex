...
\@x{}\moduleLeftDash\@xx{ {\MODULE} crackers5a}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
 ...
 \{ \} ]}%
\@x{}\midbar\@xx{}%
\@x{ Desire ( p ) \.{\defeq} \.{\land} desires [ p ] \.{=} \{ \}}%
\@x{\@s{60.77} \.{\land} holds [ p ] \.{=} \{ \}}%
...
\@x{\@s{74.01} \.{\land} desires [ p ] \.{\neq} \{ \}}%
 ...
 desires [ p ]}%
\@pvspace{8.0pt}%
 \@x{ Exclusivity \.{\defeq} {\lnot} \E\, p ,\, q \.{\in} People \.{:} p
 \.{\neq} q \.{\land} ( holds [ p ] \.{\cap} holds [ q ] ) \.{\neq} \{ \}}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
